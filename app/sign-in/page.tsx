       ...
       <div className="w-full max-w-[460px] relative z-10">
         ...
         >
           ...
           <div className="mb-8 text-center">
             <h2 className="text-2xl font-bold text-[#1a1a1c] dark:text-white tracking-tight mb-1">Welcome back</h2>
             <p className="text-sm text-[#1a1a1c]/40 dark:text-white/40 font-medium">Please enter your account details</p>
           </div>
           ...
           <form onSubmit={handleSignIn} className="space-y-5">
             ...
             <div className="space-y-2">
               ...
               <div className="flex justify-end px-1">
                 <Link href="#" className="text-[10px] font-bold text-accent hover:underline underline-offset-4 tracking-tight">
                   Forgot password?
                 </Link>
               </div>
             </div>
           ...
           <div className="mt-8 pt-8 border-t border-[#1a1a1c]/5 dark:border-white/5 text-center">
             <p className="text-[#1a1a1c]/40 dark:text-white/40 font-bold text-xs">
               ...
               <Link href="/sign-up" className="text-accent hover:underline ml-1">Create one</Link>
             </p>
           </div>
         </motion.div>
       </div>
