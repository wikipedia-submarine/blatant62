    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12 relative z-10 pt-24 sm:pt-32">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-2">Venue Requests</h1>
            <p className="text-muted-foreground">Review and approve pending venue submissions</p>
          </div>
          <Link
            href="/admin"
        ...
        {loading ? (
          ...
          <div className="p-12 rounded-2xl border-2 border-dashed border-border text-center">
            <p className="text-muted-foreground text-lg">No pending requests to review</p>
          </div>
        ) : (
                    ...
                    {expandedVenueId === venue.id && (
                      <div className="space-y-4 mb-6 p-4 rounded-lg bg-muted/30 border border-border/30">
                        ...
                        <button
                          ...
                          className="w-full mt-4 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-accent/10 border border-accent/30 text-accent font-bold transition-all hover:bg-accent hover:text-white"
                        >
                          Edit Details
                        </button>
                      </div>
